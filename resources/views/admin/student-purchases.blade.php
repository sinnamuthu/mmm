...
<html lang="zxx">
    ...
    <body>
        ...
        <div id="main-wrapper">
					...
					<div class="row student-profile-blk">
							...
							<div class="left-panel"><!--Left Panel-->								
								<div class="d-user-avater">
									...
									<ul id="side-menu">
										...
										<li><a href="student-enrollment.html"><i class="fas fa-user"></i>Enrollment</a></li>
										<li class="active"><a href="student-purchases.html"><i class="fas fa-shopping-cart"></i>Purchases</a></li>
									</ul>
								</div>
						...
						<div class="col-md-9">
							<div class="dashboard_wrap"><!--profile form-->								
								...
								<div class="student-purchase-blk">
									<div class="row justify-content-center">
										<div class="col-md-12">
											<div class="single_instructor"><!--student enroll-->
												<div class="single_instructor_thumb">
													<a href="#"><img src="../assets/img/std-enroll-img.png" class="img-fluid" alt=""></a>
												</div>
												<div class="single_instructor_caption">
													<h4><a href="#">How To Learn website pattern for succesfull software Applications</a></h4>
													<ul class="instructor_info">
														<li><p><span>By</span> Adam Wilson</p></li>
													</ul>
													<div class="btm-row row">
														<div class="col-sm-5">
															<div class="btn publish"><a href="javascript:;" data-toggle="modal" data-target="#unEnroll">Unenroll</a></div>
														</div>
														<div class="col-sm-6">
															<div class="prg-blk">															
																<div class="progress-in">
			...
			<div class="modal fade" id="unEnroll" tabindex="-1" role="dialog" aria-labelledby="unEnroll" aria-hidden="true">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">		
							<p>Student Unenrolled!</p>
							<button type="submit" class="btn btn-md theme-bg2 text-white">ok</button>
					</div>
				</div>
			</div>
			<!-- End Modal -->

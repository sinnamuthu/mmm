...
<html lang="zxx">
    ...
    <body>
        ...
        <div id="main-wrapper">
						...
						<div class="col-md-3">
							<div class="left-panel"><!--Left Panel-->								
								<div class="d-user-avater">
									...
									<ul id="side-menu">
										<li><a href="student-profile.html"><i class="fa fa-info"></i>Information</a></li>
										<li class="active"><a href="student-enrollment.html"><i class="fas fa-user"></i>Enrollment</a></li>
										<li><a href="student-purchases.html"><i class="fas fa-shopping-cart"></i>Purchases</a></li>
									</ul>
								</div>
							...
							<div class="dashboard_wrap"><!--profile form-->								
								<div class="row">
									...
									<div class="col-md-6 mb-4">
										<div class="form-group smalls text-right">
											<div class="btn secondary"><a href="javascript:;" data-toggle="modal" data-target="#cngPw">Change Password</a></div>
										</div>
									</div>
								</div>
								...
								<div class="enroll-wrap">
									<div class="row justify-content-center">
										<div class="col-md-3">
											<h4>Enrolll in Batch</h4>
											<p>Manually enroll this user in a new course. Users are not charged for manual enrollments.</p>
										</div>
										<div class="col-md-9">
											<form>
												<div class="enroll-frm-gp">
													<div class="form-group smalls">
														<div class="simple-input">
															<select id="" class="form-control" name="sel_batch">
																<option value="">Select Batch</option>
																<option value="1">Batch 2021</option>
																<option value="2">Batch 2022</option>
															</select>
														</div>
													</div>
													<div class="form-group smalls text-right noBg">
														<div class="btn primary"><a href="javascript:;">Enroll Batch</a></div>
													</div>
												</div>
											</form>
										</div>
										...
										<div class="col-md-9">
											<form>
												<div class="enroll-frm-gp">
													<div class="form-group smalls">
														<div class="simple-input">
															<select id="" class="form-control" name="sel_course">
																<option value="">Select Course</option>
																<option value="1">How To Learn	UI/UX Design Pattern For Successfull Software Applications</option>
																<option value="2">How To Learn	Website Pattern For Successfull Software Applications</option>
															</select>
														</div>
													</div>
													<div class="form-group smalls text-right noBg">
														<div class="btn primary"><a href="javascript:;">Enroll Course</a></div>
													</div>
												</div>
											</form>
										</div>
			...
			<div class="modal fade" id="cngPw" tabindex="-1" role="dialog" aria-labelledby="cngPw" aria-hidden="true">
					...
					<div class="modal-content overli">
						...
						<div class="modal-body">
							<form>								
								...
								<div class="form-group">
									<button type="submit" class="btn btn-md full-width theme-bg2 text-white">Save Changes</button>
								</div>								
							</form>
						</div>
					</div>

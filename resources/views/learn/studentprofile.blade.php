										...
										<form method="POST" action="{{ route('addstudent') }}">
											...
											<div class="form-group smalls">
												...
												<div class="simple-input">
													<select id="" class="form-control" name="prf_salutation">
											...
											<div class="form-group smalls">
												...
												<input type="text" class="form-control" value="" placeholder="Enter First name" name="prf_fname"/>
											</div>
											<div class="form-group smalls">
												<label>Last Name:</label>
												<input type="text" class="form-control" value="" placeholder="Enter Last name" name="prf_lname"/>
											</div>
											<div class="form-group smalls">
												<label>Email ID.</label>
												<input type="email" class="form-control" value="" placeholder="Enter Email Id." name="prf_email"/>
											</div>
											<div class="form-group">
												<label>Password</label>
												<input type="text" class="form-control" placeholder="*******" name="prf_pwd"/>
											</div>
											<div class="form-group smalls">
												<label>Gender:</label>
												<div class="simple-input">
													<select id="" class="form-control" name="prf_gender">
											...
											<div class="form-group smalls">
												<label>DOB:</label>
												<input type="date" class="form-control" placeholder="Enter Date of Birth" name="prf_dob"/>
											</div>
											<div class="form-group smalls">
												<label>Address 1:</label>
												<input type="text" class="form-control" placeholder="Enter Address" name="prf_add1"/>
											</div>
											<div class="form-group smalls">
												<label>Address 2:</label>
												<input type="text" class="form-control" placeholder="Enter Address" name="prf_add2"/>
											</div>
											<div class="form-group smalls">
												<label>City:</label>
												<input type="text" class="form-control"  placeholder="Enter City" name="prf_city"/>
											</div>
											<div class="form-group smalls">
												<label>Pin/zip Code:</label>
												<input type="text" class="form-control"  placeholder="Enter Pin code" name="prf_pin"/>
											</div>
											<div class="form-group smalls">
												<label>Country:</label>
												<input type="text" class="form-control"  placeholder="Enter Country" name="prf_country"/>
											</div>
											<div class="form-group smalls">
												<label>Mobile:</label>
												<input type="text" class="form-control" placeholder="Enter Mobile No." name="prf_mobile"/>
											</div>
											<div class="form-group smalls">
												<label>Qualification:</label>
												<input type="text" class="form-control" placeholder="Enter Qualification" name="prf_qualification"/>
											</div>
											<div class="form-group smalls">
												<label>Company</label>
												<input type="text" class="form-control" placeholder="Enter Company" name="prf_company"/>
											</div>
											<div class="form-group smalls">
												<label>Organisation Name / Hospital /Institude:</label>
												<input type="text" class="form-control" placeholder="Enter Organisation" name="prf_organ"/>
											</div>
											<div class="form-group smalls text-right">

    ...
    return u.input || wt(), u.addTest = function(n, t) {
        ...
        function(n, t) {
            ...
            function l(n, r, u) {
                ...
                u || (u = o(r));
                var f;
                return f = u.cache[n] ? u.cache[n].cloneNode() : p.test(n) ? (u.cache[n] = u.createElem(n)).cloneNode() : u.createElem(n), f.canHaveChildren && !y.test(n) && !f.tagUrn ? u.frag.appendChild(f) : f
            }
            ...
            function a(n) {
                n || (n = t);
                var u = o(n);
                return !r.shivCSS || f || u.hasCSS || (u.hasCSS = !!w(n, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), i || k(n, u), n
            }
            var v = "3.7.0",
                u = n.html5 || {},
